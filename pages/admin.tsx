              ...
              <Card className="w-full max-w-md backdrop-blur-xl bg-slate-900/95 border border-white/20 shadow-2xl">
                ...
                <CardBody className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="flat" onPress={() => setSelectedDevice(null)}>
                      Cancel
                    </Button>
                  </div>
                </CardBody>
          ...
          {showSmsModal && selectedUser && selectedUser.phoneNumber && (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <Card className="w-full max-w-md backdrop-blur-xl bg-slate-900/95 border border-white/20 shadow-2xl">
                <CardHeader className="border-b border-white/10">
                  <div>
                    <h3 className="text-lg font-semibold text-white">Send SMS Message</h3>
                    <p className="text-sm text-gray-400">
                      To {selectedUser.email} at {" "}
                      <span className="font-mono">{formatPhoneNumber(selectedUser.phoneNumber)}</span>
                    </p>
                  </div>
                </CardHeader>
                <CardBody className="space-y-4">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-200" htmlFor="sms-message">
                      SMS Message
                    </label>
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      ...
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          setSmsMessage("Reminder: Please log your health metrics in the HealthTrackerAI app today.")
                        }
                      >
                        Reminder
                      </button>
                    ...
                    <div className="flex justify-between items-center">
                      <p className="text-xs text-gray-400">{smsMessage.length}/160 characters</p>
                      {smsMessage.length > 160 && <p className="text-xs text-red-400">Message too long</p>}
                    </div>
                  </div>
              ...
              <Card className="w-full max-w-md backdrop-blur-xl bg-slate-900/95 border border-white/20 shadow-2xl">
                ...
                <CardBody className="space-y-4">
                  <div className="space-y-4">
                    {/* Title Input */}
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-gray-200" htmlFor="fcm-title">
                        Notification Title
                      </label>
                      <input
                      ...
                      />
                      <p className="text-xs text-gray-400">{fcmTitle.length}/50 characters</p>
                    </div>

                    {/* Message Input */}
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-gray-200" htmlFor="fcm-message">
                        Notification Message
                      </label>
                      <textarea
                        className="w-full min-h-[100px] p-3 rounded-lg bg-white/10 border border-white/20 text_white placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        id="fcm-message"
                        maxLength={200}
                      ...
                      />
                      <p className="text-xs text-gray-400">{fcmMessage.length}/200 characters</p>
                    </div>
            ...
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <Card className="w-full max-w-2xl max-h-[90vh] overflow-auto bg-white/95 backdrop-blur-md shadow-2xl border-0 ring-1 ring-gray-200/50">
                <CardHeader className="pb-2 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200/30">
                  ...
                  <p className="text-sm text-gray-600">To: {selectedUser.email}</p>
                </CardHeader>
                <CardBody className="space-y-4 bg-white/90">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2 text-gray-800" htmlFor="email-message">
                      Message
                    </label>
                    <textarea
                      id="email-message"
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-blue-50/30 p-4 rounded-lg border border-gray-200/50 shadow-sm">
                    <p className="text-sm font-medium text-gray-800 mb-3">Quick Templates:</p>
                    <div className="space-y-2">
                      <Button
